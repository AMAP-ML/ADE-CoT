...
class GPT4v():
    def __init__(self, api_key_path=None, are_images_encoded=False, model_name="gpt-4o-0806"):
        """OpenAI GPT-4-vision model wrapper.

        Reads the API key and endpoint URL from environment variables:
            OPENAI_API_KEY  : your OpenAI (or compatible) API key
            OPENAI_API_BASE : base URL of the chat-completions endpoint
        ...
        Args:
            ...
            model_name (str): Backend chat-completion model identifier.
        """
    ...
    def get_parsed_output(self, prompt, constant_flag=False):
...
class GPT4o(GPT4v):
    def __init__(self, api_key_path=None, are_images_encoded=True, model_name="gpt-4o-0806"):
