...
def upload(
    ...
    if not exists_repo(repo_id=repo_id, repo_type=repo_type, token=token):
        ...
        except Exception as e:  # catch broadly: we have seen RepositoryNotFoundError but want to be safe
            logger.error("===========================================")
    ...
    def uploader():
        ...
        except Exception as e:  # catch broadly: RuntimeError has been observed but other exceptions may occur
            logger.error("===========================================")
