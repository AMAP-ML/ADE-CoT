...
class LoRAModule(torch.nn.Module):
    ...
    def __init__(
        ...
        self.register_buffer("alpha", torch.tensor(alpha))  # treat as a constant
    ...
    def forward(self, x):
        ...
        if self.split_dims is None:
            ...
            if self.rank_dropout is not None and self.training:
                ...
                # Could be computed from a mask, but using rank_dropout for its augmentation-like effect.
...
class LoRAInfModule(LoRAModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.org_module_ref = [org_module]  # keep a reference for later use
        self.enabled = True
    ...
    # Freeze and merge into the original module.
    ...
    # Return this module's weight so the merge can be restored later.
...
class LoRANetwork(torch.nn.Module):
    ...
    def __init__(
                ...
                if target_replace_modules is None or module.__class__.__name__ in target_replace_modules:
                    ...
                    for child_name, child_module in module.named_modules():
                        ...
                        if is_linear or is_conv2d:
                            ...
                            if modules_dim is not None:
                                # explicit module list specified
                            ...
                            if dim is None or dim == 0:
                                # Log information about skipped modules.
        ...
        # TODO: creating every module on each call is wasteful; revisit.
    ...
    # Whether the LoRA can be merged in-place.
