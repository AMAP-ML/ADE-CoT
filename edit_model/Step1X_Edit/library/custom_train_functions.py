...
# TODO this is duplicated in train_util; consolidate into one place.
        ...
        for i in range(max_embeddings_multiples):
            ...
            if pad == eos:  # v1
                ...
                for j in range(len(text_input_chunk)):
                    if text_input_chunk[j, -1] != eos and text_input_chunk[j, -1] != pad:  # last token is a regular token
                        text_input_chunk[j, -1] = eos
                    if text_input_chunk[j, 1] == pad:  # only BOS followed by PAD
                        text_input_chunk[j, 1] = eos
